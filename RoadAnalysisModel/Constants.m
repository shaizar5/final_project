classdef Constants   
    properties (Constant = true)
        ...
        HOMOGRAPHY_UNIT_TEST_ON_ROAD = 150;
        HOMOGRAPHY_UNIT_TEST_ABOVE_ROAD = 50;
        
        TRANSLATION_VECTOR_UNIT_TEST = 0;
        TRANSLATION_VECTOR_DEG = 0;
        TRANSLATION_VECTOR_FACTOR = 0.5;
        ...
        MIN_CAMERA_ROTATION_HORIZON_IN_DEGREES_MISTAKE = -10;
        MAX_CAMERA_ROTATION_HORIZON_IN_DEGREES_MISTAKE = 10;
